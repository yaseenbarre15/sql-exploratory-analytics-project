# sql-exploratory-analytics-project
Built advanced SQL analytics to evaluate product and customer performance using YoY analysis, cumulative trends, ranking, and segmentation.

**Advanced SQL Analytics Project**

This repository focuses on advanced SQL analytics performed on a structured data warehouse. The goal of this project is to transform curated data into meaningful business insights using a wide range of analytical techniques.

🎯 **Project Objective**

To demonstrate the ability to perform in-depth data analysis using SQL, uncover trends, evaluate performance, and generate insights across product and customer dimensions.
